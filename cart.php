            ...
            <div class="site-blocks-table">
              <table class="table table-bordered">
                ...
                <?php
                  $total = 0;
                  if(isset($_SESSION['carrito1'])){
                    $arreglocarrito1 = $_SESSION['carrito1'];
                    for($i=0;$i<count($arreglocarrito1);$i++){
                      $total= $total + ( $arreglocarrito1[$i]['Precio'] * $arreglocarrito1[$i]['Cantidad']);
                ?>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/<?php echo $arreglocarrito1[$i]['Imagen'];?>" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black"><?php echo $arreglocarrito1[$i]['Nombre'];?></h2>
                    </td>
                    <td>$<?php echo $arreglocarrito1[$i]['Precio'];?></td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
                        ...
                        data-precio="<?php echo $arreglocarrito1[$i]['Precio'];?>"
                        data-id="<?php echo $arreglocarrito1[$i]['Id'];?>"
                        value="<?php echo $arreglocarrito1[$i]['Cantidad'];?>" 
                    ...
                    <td class="cant<?php echo $arreglocarrito1[$i]['Id']; ?>">
                      $<?php echo $arreglocarrito1[$i]['Precio'] * $arreglocarrito1[$i]['Cantidad'];?></td>
                    <td><a href="#" class="btn btn-primary btn-sm btnEliminar" data-id="<?php echo $arreglocarrito1[$i]['Id'];?>">X</a></td>
                  </tr>
          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <button class="btn btn-primary btn-sm btn-block">Actualizacion de la compra</button>
              </div>
              <div class="col-md-6">
