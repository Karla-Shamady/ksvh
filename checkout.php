...
<html lang="en">
  <head>
    <title>Compradores &mdash; NEW COLLECTION</title>
    <meta charset="utf-8">
        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="border p-4 rounded" role="alert">
              ¿Eres cliente? <a href="login.php">Haga clic aqui</a> para iniciar sesion
            </div>
          </div>
        </div>
        <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="collapse" id="ship_different_address">
                    <div class="py-2">
                      ...
                      <div class="form-group row">
                        <div class="col-md-12">
                          <label for="c_diff_companyname" class="text-black">Compañia </label>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <label for="c_diff_postal_zip" class="text-black">C.P <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
              ...
              <div class="row mb-5">
                <div class="col-md-12">
                  <h2 class="h3 mb-3 text-black">Codigo Promocional</h2>
                  <div class="p-3 p-lg-5 border">
                    
                    <label for="c_code" class="text-black mb-3">Ingrese su código de cupón si tiene uno </label>
                    <div class="input-group w-75">
                      <input type="text" class="form-control" id="c_code" placeholder="Código de Cupón" aria-label="Codigo de Cupon" aria-describedby="button-addon2">
